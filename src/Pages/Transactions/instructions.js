...
function Instructions() {
    return (
        <div className="d-flex justify-content-center">
            <Card style={{ width: '800px', height: '1100px', marginTop: '50px', marginRight: '50px', marginBottom: '50px' }}>
                <Card.Header className="d-flex justify-content-center" style={{ fontSize: '20px' }}>Transfer Instructions</Card.Header>
                <Card.Body style={{ padding: '30px' }}>
                    <Card.Title className="mb-5">IMPORTANT: After completing the transaction and taking the screenshot (via the instructions below), make sure to go to the ongoing transaction and upload the image of the screenshot for us to further process the current transaction.</Card.Title>
                    ...
                    <Card.Subtitle className="mb-3">6. Check all the details</Card.Subtitle>
                    <Card.Subtitle className="mb-5">7. Take the screenshot of the successful transaction</Card.Subtitle>
